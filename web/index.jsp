		...
		<div class="container-fluid">
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<c:forEach items="${hotProductService }" var="hotProduct">
			...
			<div class="container-fluid">
				...
				<div class="col-md-10">
					...
					<c:forEach items="${newProductService }" var="newProduct">
						<div class="col-md-2" style="text-align:center;height:200px;padding:10px 0px;">
							<a href="product_info.htm">
							...
							<p><font color="#E4393C" style="font-size:16px">${newProduct.shop_price}</font></p>
						</div>
					</c:forEach>
				</div>
			</div>			
